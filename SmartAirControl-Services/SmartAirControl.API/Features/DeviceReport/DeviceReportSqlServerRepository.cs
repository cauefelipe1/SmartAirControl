...
{
    public class DeviceReportSqlServerRepository : IDeviceReportRepository
    {
        private readonly DapperContext _dapperContext;

        public DeviceReportSqlServerRepository(DapperContext dapperContext) => _dapperContext = dapperContext;
        ...
        const string INSERT_DEVICE_REPORT = @"
            ...
            OUTPUT INSERTED.DeviceReportId
            VALUES (
                @DeviceId,
                @DeviceRegistrationId,
                @ReportType,
