...
namespace SmartAirControl.API.Features.DeviceAlert
{
    ...
    public class DeviceAlertSqLiteRepository : IDeviceAlertRepository
    {
        private readonly DapperContext _dapperContext;

        public DeviceAlertSqLiteRepository(DapperContext dapperContext) => _dapperContext = dapperContext;
