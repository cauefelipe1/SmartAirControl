...
namespace SmartAirControl.API.Features.DeviceAlert
{
    ...
    public class DeviceAlertPostgreSqlRepository : IDeviceAlertRepository
    {
        private readonly DapperContext _dapperContext;

        public DeviceAlertPostgreSqlRepository(DapperContext dapperContext) => _dapperContext = dapperContext;
